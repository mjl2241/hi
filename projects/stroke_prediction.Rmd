...
Although stroke is preventable and treatable, it is a leading cause of death and serious disability for adults in the United States (<https://www.cdc.gov/stroke/index.htm>). Globally, stroke causes over 6 million deaths per year. Also, 70% of strokes and 87% of both stroke-related deaths and disability occur in low and middle-income countries (<https://www.who.int/bulletin/volumes/94/9/16-181636.pdf>). Hence, predicting stroke cases based on certain health indicators might be beneficial in potentially preventing strokes in the world’s marginalized communities. 
...
Conclusions
The demographic and clinical variables in the dataset can be used to build a model for stroke prediction. The final model in this analysis was an AdaBoost model, and the area under the ROC curve of the final model in the test dataset was 0.844. 
The findings are in line with my expectations. According to the findings, age was an important variable for stroke prediction, and the test performance of the final model was good.
...
Figure 2. density plots of continuous predictors across levels of “stroke”
...
Figure 3. bar charts of stroke event proportion across categories of categorical predictors
 
*Note: numbers on the bars are numbers of stroke cases in the category
...
Figure 4. resampling areas under the ROC curves of models in the training dataset
...
Figure 5. areas under the ROC curves of models in the test dataset
...
Figure 6. variable importance in the final model (model 4: AdaBoost)
